...
def signup():
    ...
    if request.method == 'POST':
        ...
        fname=fnm.strip()
        if len(fname) >=20:
            return render_template('signup.html',error='First name field can handel upto 20 character')
        ...
        if fname.isalpha() or fname.count(" ")==2 or fname.count(" ")==1:
            ...
            return render_template('signup.html',error='enter correct name in the First name field')
        # for single space 
        ...
        if lname.isalpha() or lname.count(" ")==2 or lname.count(" ")==1:
            ...
            return render_template('signup.html',error='enter correct name in the Last name field it should be alphabet')
        if len(fname) >=20:
            return render_template('signup.html',error='Last name field can handel upto 20 character')
